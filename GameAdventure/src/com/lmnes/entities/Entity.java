...
public class Entity {
	...
	public static BufferedImage GUN_RIGHT_DAMAGE = Game.spritesheet.getSprite(0, 32, 16, 16);
	public static BufferedImage GUN_LEFT_DAMAGE = Game.spritesheet.getSprite(16, 32, 16, 16);
	...
	public static boolean isColidding(Entity e1,Entity e2) {
		...
		Rectangle e2Mask = new Rectangle(e2.getX() + e2.maskx,e2.getY()+e2.masky,e2.mwidth,e1.mheight);
